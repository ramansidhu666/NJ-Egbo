    ...
    public partial class HomeMaster : System.Web.UI.MasterPage
    {
        ...
        private void BindMenusList()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                StrMenu.Append("<li class='sidebar-brand'> <a href='#' class='menu_heding'> NJ Egbo-Nwalor</a></li>");
                ...
                StrMenu.Append("<li><a href='https://www.realtor.ca/' title='Realtor.ca'>Realtor.ca</a></li>");
